...
class SpringBootSettingsApplierTest : IdeaSettingsTestFixture() {
    ...
    public override fun setUp() {
        settingsApplier = SpringBootSettingsApplier(project, platform.runManager)
    }
    ...
    fun overrideParametersApplied() {
        ...
        val runnerAndConfigurationSettings = platform.runManager.findConfigurationByName("Spring Boot With Override")!!
