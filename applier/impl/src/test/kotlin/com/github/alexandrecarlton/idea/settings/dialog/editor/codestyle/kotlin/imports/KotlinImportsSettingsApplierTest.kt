...
class KotlinImportsSettingsApplierTest : IdeaSettingsTestFixture() {
    ...
    public override fun setUp() {
        ...
        settingsApplier = KotlinImportsSettingsApplier(kotlinCodeStyleSettings)
    }
    ...
    fun topLevelSymbols() {
        ...
        assertThat(kotlinCodeStyleSettings.NAME_COUNT_TO_USE_STAR_IMPORT).isEqualTo(Int.MAX_VALUE)

        settingsApplier.apply(KotlinImportsSettings(
            topLevelSymbols = UseImportWithWildcardSettings))
        assertThat(kotlinCodeStyleSettings.NAME_COUNT_TO_USE_STAR_IMPORT).isEqualTo(1)

        settingsApplier.apply(KotlinImportsSettings(
            topLevelSymbols = UseImportWithWildcardWhenAtLeastNamesUsedSettings(10)))
        assertThat(kotlinCodeStyleSettings.NAME_COUNT_TO_USE_STAR_IMPORT).isEqualTo(10)
    }
    ...
    fun javaStaticsAndEnumMembers() {
        ...
        assertThat(kotlinCodeStyleSettings.NAME_COUNT_TO_USE_STAR_IMPORT_FOR_MEMBERS).isEqualTo(Int.MAX_VALUE)

        settingsApplier.apply(KotlinImportsSettings(
            javaStaticsAndEnumMembers = UseImportWithWildcardSettings))
        assertThat(kotlinCodeStyleSettings.NAME_COUNT_TO_USE_STAR_IMPORT_FOR_MEMBERS).isEqualTo(1)

        settingsApplier.apply(KotlinImportsSettings(
            javaStaticsAndEnumMembers = UseImportWithWildcardWhenAtLeastNamesUsedSettings(10)))
        assertThat(kotlinCodeStyleSettings.NAME_COUNT_TO_USE_STAR_IMPORT_FOR_MEMBERS).isEqualTo(10)
    }
    ...
    fun packagesToUseImportWithWildcard() {
        ...
        assertThat(kotlinCodeStyleSettings.PACKAGES_TO_USE_STAR_IMPORTS).isEqualTo(PackageEntryTable().apply {
